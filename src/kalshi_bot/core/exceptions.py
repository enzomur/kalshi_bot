"""Custom exceptions for the Kalshi bot."""
...
class ArbitrageError(KalshiBotError):
    """Arbitrage detection or execution error."""
...
class ProfitLockError(KalshiBotError):
    """Profit lock constraint violation."""

    def __init__(
        self,
        message: str,
        locked_amount: float | None = None,
        attempted_use: float | None = None,
        details: dict[str, Any] | None = None,
    ) -> None:
        super().__init__(message, details)
        self.locked_amount = locked_amount
        self.attempted_use = attempted_use
